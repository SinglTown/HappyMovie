...
#pragma mark - setPhotos
- (void)setPhotos:(NSMutableArray *)photos withViewBounds:(CGSize)viewBounds
{
...
//    [animation setToValue:[NSValue valueWithCGPoint:CGPointMake(viewBounds.width/2, viewBounds.height/2)]];
...
- (CAEmitterLayer*) buildEmitterSteam:(CGSize)viewBounds positon:(CGPoint)postion
{
    ...
    cell.contents = (id)[[UIImage imageNamed:@"steam"] CGImage];
    [cell setName:@"steam"];
...
{
    CGFloat height = viewBounds.height/11;
    ...
    textLayer.strokeColor = kBrightBlue.CGColor;
...
- (void)aniamtionLikeGameCenterBubble:(CALayer*)layer
{
    ...
    CGRect circleContainer = CGRectInset(layer.frame, layer.bounds.size.width / 2 - 3, layer.bounds.size.width / 2 - 3);
    CGPathAddEllipseInRect(curvedPath, NULL, circleContainer);
    
    pathAnimation.path = curvedPath;
    CGPathRelease(curvedPath);
    [layer addAnimation:pathAnimation forKey:@"CircleAnimation"];
    ...
    [layer addAnimation:scaleX forKey:@"scaleXAnimation"];
    ...
    scaleX.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
    [layer addAnimation:scaleY forKey:@"scaleYAnimation"];
}
