...
@interface MontageVideoViewController ()<CTAssetsPickerControllerDelegate, UIPopoverControllerDelegate, SelectViewDelegate, ScrollSelectViewDelegate, ColorScrollSelectViewDelegate, PBJVideoPlayerControllerDelegate>
{
...
@implementation MontageVideoViewController
...
- (void)createPopTipView
{
    ...
    NSString *hint = GBLocalizedString(@"选择视频");
...
{
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"下一步" style:UIBarButtonItemStylePlain target:self action:@selector(pickMusicFromCustom)];
    
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"选择" style:UIBarButtonItemStylePlain target:self action:@selector(pickupVideos:)];
    ...
    [self.navigationItem.leftBarButtonItem setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor], NSFontAttributeName:[UIFont systemFontOfSize:15]} forState:UIControlStateNormal];
}
...
- (void)createPuzzleSelectView
{
   ...
   [_puzzleView setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:1.0]];
...
- (void)createGifSelectView
{
    ...
    [_gifView setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:1.0]];
...
- (void)createBorderSelectView
{
    ...
    [_borderView setBackgroundColor:[[UIColor blackColor] colorWithAlphaComponent:1.0]];
...
- (void)createColorSelectView
{
    ...
    [_colorView setBackgroundColor:[[UIColor clearColor] colorWithAlphaComponent:0.6]];
...
- (void)viewDidLoad
{
    ...
    UIButton *backButton = [UIButton buttonWithType:1];
    backButton.frame = CGRectMake(10, 70, 30, 30) ;
    [backButton setBackgroundImage:[UIImage imageNamed:@"btn_close@2x" ] forState:UIControlStateNormal];
