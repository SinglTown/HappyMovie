...
typedef void (^GoBack)(NSMutableArray* finish);
typedef void (^GoBackWithBool)(BOOL finish);


typedef void (^ReGoBack)(NSMutableArray* finish);
typedef void (^ReGoBackWithBool)(BOOL finish);
...
//@property(nonatomic,strong)ZYQAssetViewController*zyqvc;
@end
