...
- (void)setFrameVertical:(CGRect)frame numberOfFields:(NSInteger)number withCornerRadius:(CGFloat)cornerRadius
{
    ...
    if (number==5) {
        ...
        labelFive.textAlignment=NSTextAlignmentCenter;
...
- (void)finishedDraggingVertical:(UIButton *)button withEvent:(UIEvent *)event
{
    ...
    diffone=fabs(button.frame.origin.y-labelOne.frame.origin.y);
    difftwo=fabs(labelTwo.frame.origin.y-button.frame.origin.y);
    diffthree=fabs(labelThree.frame.origin.y-button.frame.origin.y);
    difffour=fabs(labelFour.frame.origin.y-button.frame.origin.y);
    difffive=fabs(labelFive.frame.origin.y-button.frame.origin.y);
...
- (void)finishedDraggingHorizontal:(UIButton *)button withEvent:(UIEvent *)event
{
    ...
    float diffone,difftwo,diffthree,difffour,difffive;
    diffone=fabs(button.frame.origin.x-labelOne.frame.origin.x);
    difftwo=fabs(labelTwo.frame.origin.x-button.frame.origin.x);
    diffthree=fabs(labelThree.frame.origin.x-button.frame.origin.x);
    difffour=fabs(labelFour.frame.origin.x-button.frame.origin.x);
    difffive=fabs(labelFive.frame.origin.x-button.frame.origin.x);
